...
<script>
    $(document).ready(function() {
        $(document).on('click', '.btn-detail', function(e) {
            ...
            const url = '<?= base_url('admin/usermanagement/getClient/') ?>' + id_client;
            $.ajax({
                url: url,
                type: 'POST',
                dataType: 'json',
                success: function(data) {
                    ...
                    if (data) {
                        ...
                        $('#detailForm').find('input[name="password"]').val(data.password);
                        $('#detailForm').find('input[name="role_id"]').val(data.role_id);
                        $('#detailForm').find('input[name="created_at"]').val(data.created_at);
                        $('#detailForm').find('input[name="updated_at"]').val(data.updated_at);
                    } else {
